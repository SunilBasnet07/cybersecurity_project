...
const Register = () => {
  ...
  return (
    <motion.div
      className="min-h-screen py-4 bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center px-4 sm:px-6 lg:px-8 "
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
      transition={{ duration: 0.5 }}
    >
      <motion.div
        className="max-w-4xl w-full space-y-6 bg-white p-8 rounded-xl shadow-2xl"
      ...
      >
        ...
        <motion.div className="text-center flex justify-center ml-12 gap-3 items-center" variants={itemVariants}>
          <div>
            <h2 className=" text-3xl font-Nunito-ExtraBold text-gray-900">
              Create Account
            </h2>
        ...
        {/* Registration Form */}
        <motion.form onSubmit={handleSubmit(submitForm)} className="mt-2 space-y-6" variants={itemVariants}>
          {/* User Name */}
